<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="考勤人员id" prop="userId">
        <el-input
          v-model="queryParams.userId"
          placeholder="请输入考勤人员id"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="考勤人员签到时间" prop="date">
        <el-input
          v-model="queryParams.date"
          placeholder="请输入考勤人员签到时间"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="考勤人员签到地点" prop="location">
        <el-input
          v-model="queryParams.location"
          placeholder="请输入考勤人员签到地点"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      ...
      <el-form-item label="考勤人员姓名" prop="username">
        <el-input
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="考勤人员id" prop="userId">
          <el-input v-model="form.userId" placeholder="请输入考勤人员id" />
        </el-form-item>
        <el-form-item label="考勤人员签到时间" prop="date">
          <el-input v-model="form.date" placeholder="请输入考勤人员签到时间" />
        </el-form-item>
        <el-form-item label="考勤人员签到地点" prop="location">
          <el-input v-model="form.location" placeholder="请输入考勤人员签到地点" />
        </el-form-item>
        <el-form-item label="经度" prop="longitude">
        ...
        <el-form-item label="考勤人员姓名" prop="username">
          <el-input v-model="form.username" placeholder="请输入考勤人员姓名" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除外检考勤编号为"' + ids + '"的数据项？').then(function() {
